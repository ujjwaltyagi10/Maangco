...
export function FrontendPanel({
  ...
  const roadmapPct =
    roadmapDayCount > 0 ? Math.round((doneDays / roadmapDayCount) * 100) : 0;
  const feArcR = 22;
  ...
  const questionsPct =
    questions.length > 0
      ? Math.round((doneQuestions / questions.length) * 100)
      : 0;
  ...
  return (
    <div className="frontend-panel">
      ...
      <div className="fe-main">
        ...
        <div className="dsa-progress-header">
          <div className="dsa-header-identity">
            ...
            <div className="dsa-header-title-group">
              ...
              <span className="dsa-header-sub">
                45-day roadmap · {roadmapWeeks.length} tracks ·{" "}
          ...
          <div className="dsa-progress-card">
            <div className="dsa-mini-ring">
              <svg viewBox="0 0 56 56" className="dsa-mini-ring-svg">
                <circle
                  ...
                  stroke="var(--border2)"
                  strokeWidth="3"
                  strokeDasharray={`${feArcLen} ${feArcGap}`}
                  strokeLinecap="round"
                ...
                <circle
                  ...
                  stroke="var(--accent)"
                  strokeWidth="3"
                  strokeDasharray={`${arcFill} ${feArcCirc - arcFill}`}
                  strokeLinecap="round"
                  transform="rotate(135, 28, 28)"
            ...
            <div className="dsa-progress-info">
              <span className="dsa-progress-count">
                {arcDone}
                <span className="dsa-progress-total">/{arcTotal}</span>
              </span>
          ...
          <div className="dsa-header-bottom">
            ...
            <div
              className={`fe-tab-strip${activeTab === "questions" ? " fe-tab-strip--hide-mobile" : ""}`}
            >
              <button
                type="button"
                ...
                <div className="dsa-filter-wrap" ref={filtersRef}>
                  ...
                  >
                    ...
                    {difficultyFilter !== "All" && (
                      <span className="dsa-filter-badge">1</span>
                    )}
                    <svg
                      className="filter-btn-chevron"
                      viewBox="0 0 12 12"
                      width="10"
                      height="10"
                      fill="currentColor"
                  ...
                  <div key={week.id} className="week-card">
                    ...
                    >
                      ...
                      <div className="week-card-info">
                        ...
                        {week.subtitle && (
                          <div className="week-card-subtitle">
                            {week.subtitle}
                          </div>
                        )}
                      </div>
                      <div className="week-card-actions">
                        <span className="week-prog-count">
                    ...
                    {expanded && (
                      <div className="week-card-body">
                        ...
                        <div className="fe-day-list">
                          {week.days.map((day) => {
                            const isDone = completedRoadmapDays.includes(
                              day.day,
                            );
                            return (
                              <button
                              ...
                              >
                                ...
                                />
                                <span className="fe-day-num">
                                  Day {day.day}
                                </span>
                                <div className="fe-day-info">
                                  <span className="fe-day-title">
                                    {day.title}
                                  </span>
                                  {day.summary && (
                                    <span className="fe-day-summary">
                                      {day.summary}
                                    </span>
                                  )}
                                </div>
                                {day.topic && (
                                  <span className="fe-day-topic">
                                    {day.topic}
                                  </span>
                                )}
                              </button>
          ...
          {activeTab === "questions" &&
            (!isPremium ? (
              <div className="fe-questions-gate">
                ...
                <div className="fe-gate-sub">
                  275 curated questions across JS, React, TypeScript, Testing
                  &amp; more — unlock with Premium.
                </div>
                <button
                  type="button"
                  className="dsa-gate-btn fe-gate-btn"
                        ...
                        >
                          ...
                          <td>
                            <span
                              ...
                              style={{ background: diffBg, color: diffText }}
                            >
                              {q.difficulty}
                            </span>
                          </td>
      ...
      {activeTab === "questions" && isPremium && (
        <aside
          className={`fe-cat-sidebar${sidebarCollapsed ? " fe-cat-sidebar--collapsed" : ""}`}
        >
          {sidebarCollapsed ? (
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background:
                          selectedCategory === cat ? color : undefined,
              ...
              <div className="sd-cosb-footer">
                ...
                <div className="gs-bar">
                  <div
                    className="gs-fill"
                    style={{
                      width: `${questions.length ? Math.round((doneQuestions / questions.length) * 100) : 0}%`,
                    }}
                  />
                </div>
